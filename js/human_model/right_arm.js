...
export function buatLenganKanan() {
    ...
    jempolMesh.position.set(-0.035, 0, -0.02); // Jempol kanan menghadap kiri
    jempolMesh.rotation.y = 0.4; 
    telapakMesh.add(jempolMesh);

    pangkalBahu.position.set(0.13, 0.65, 0.15); // Diatur pas di pandangan FPS kanan
